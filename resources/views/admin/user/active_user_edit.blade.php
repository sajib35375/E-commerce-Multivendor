         ...
         <div class="col-md-12">
             <div class="card">
                 ...
                 <div class="card-body">
                     ...
                     <form action="{{ route('active.user.update',$edit_data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                         <div class="my-3">
                         ...
                         <div class="my-3">
                             ...
                             <img id="img" style="width: 70px;height: 70px;" src="{{ $edit_data->photo ? 'http://localhost:8000/uploads/user/'.$edit_data->photo : 'http://localhost:8000/uploads/user/no_image.jpg' }}" alt="">
