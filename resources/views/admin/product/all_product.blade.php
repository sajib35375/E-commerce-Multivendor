        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>All Product</h2>
                    <a style="float: right;" class="btn btn-primary" href="{{ route('add.new.product') }}">Add New Product</a>
                </div>
                <div class="card-body">
                    <table id="example" class="table table-bordered table-striped text-center">
                        ...
                        <tr>
                            ...
                            <td> @if($item->vendor_charge) <span class="">{{ $item->vendor_charge }} ৳</span> @else <span class="badge badge bg-danger">Owner</span> @endif </td>
                            ...
                            <td>
                                <a class="btn btn-info" href="{{ route('product.edit',$item->id) }}"><i class="fa fa-pencil"></i></a>
                                <a id="delete" class="btn btn-danger" href="{{ route('product.delete',$item->id) }}"><i class="fa fa-trash"></i></a>
                                <a class="btn btn-warning" href="{{ route('single.product.details',$item->id) }}"><i class="fa fa-eye"></i></a>
                                 @if($item->status==1)
                                    <a class="btn btn-primary" href="{{ route('product.inactive',$item->id) }}"><i class="fa fa-thumbs-down"></i></a>
                                 @else
                                    <a class="btn btn-primary" href="{{ route('product.active',$item->id) }}"><i class="fa fa-thumbs-up"></i></a>
                                 @endif
                            </td>
                        </tr>
