                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" name="vendor_id" id="inputCollection">
                                                ...
                                                @foreach($activeVendor as $vendor)
                                                    <option {{ $edit_product->vendor_id == $vendor->id ? 'selected' : '' }} value="{{ $vendor->id }}">{{ $vendor->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <form action="{{ route('multi.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a id="delete" class="btn btn-danger" href="{{ route('multi.delete',$img->id) }}">Delete</a>
                        </td>
                    </tr>
