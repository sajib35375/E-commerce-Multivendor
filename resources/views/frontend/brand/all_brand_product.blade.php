                ...
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        ...
                        <div class="breadcrumb">
                            ...
                            <span></span> Brand <span></span> {{ $brand->name }}
                        </div>
                    </div>
        ...
        <div class="row flex-row-reverse">
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        @foreach($brands as $item)
                            @php
                                $pro_numb = \App\Models\Product::where('status',1)->where('brand_id',$item->id)->count();
                            @endphp
                            <li>
                                <a href="{{ route('all.brand.product',$item->id) }}"> <img src="{{ URL::to('') }}/AdminBackend/upload/admin/brand/{{ $item->photo }}" alt="" />{{ $item->name }}</a><span class="count">{{ $pro_numb }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="sidebar-widget price_range range mb-30">
                    ...
                    <form action="{{ route('brand.price.filter',$brand->id) }}" method="GET">
                        @csrf
                        <div class="price-filter mb-30">
                            <div class="price-filter-inner">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="caption">From: <strong id="slider-range-value1" class="text-brand">0 ৳</strong></div>
