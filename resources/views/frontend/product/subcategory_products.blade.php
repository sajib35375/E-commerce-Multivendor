        ...
        <div class="container">
            <div class="archive-header">
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <a href="{{ route('subcategory.products',$subcat->id) }}"><h1 class="mb-15">{{ $subcat->sub_name }}</h1></a>
            ...
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>We found <strong class="text-brand">{{ count($all_sub_cat_pro) }}</strong> items for you!</p>
                    </div>
                ...
                <div class="row product-grid">
                    ...
                    @foreach($all_sub_cat_pro as $item)
