                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($order->status=='pending')
                                                                <span class="badge badge-pill bg-primary">{{ $order->status }}</span>
                                                            @elseif($order->status=='confirm')
                                                                <span class="badge badge-pill bg-info">{{ $order->status }}</span>
                                                            @elseif($order->status=='processing')
                                                                <span class="badge badge-pill bg-warning">{{ $order->status }}</span>
                                                            @elseif($order->status=='delivered')
                                                                <span class="badge badge-pill bg-success">{{ $order->status }}</span>
                                                                @if($order->return_order == 1)
                                                                    <span class="badge badge-pill bg-danger">return</span>
                                                                @else
                                                                @endif
                                                            @endif
                                                        </td>
