(function ($){
    $(document).ready(function (){
       ...
       $(document).on('change','input#photo',function (e){
        ...
        $(document).on('change','input[name="category_image"]',function (e){
            e.preventDefault();
        ...
        $(document).on('change','input[name="slider_image"]',function (e){
                    e.preventDefault();
       ...
       $(document).on('change','select[name="category_id"]',function (e){
           ...
           if (category_id){
               $.ajax({
                   url : main_domain+"select/subcategory/"+category_id,
                   type : "GET",
                   dataType : "json",
